...
def osi_yaml_to_snowflake_semantic_view_ddl(
    ...
    """
    raw = yaml.safe_load(osi_yaml_path.read_text(encoding="utf-8"))  # noqa: TID251 — dagster-open-platform type-checks against published dagster-shared, which doesn't yet export safe_load_yaml.
