...
def predict_and_write_to_snowflake(output_table="model_opportunity_win_probability_predictions"):
    ...
    try:
        ...
        # Align X to exactly the features the model was trained on
        ...
        # reindex fills missing columns (e.g. unseen dummy categories) with 0
        X_filtered = X.reindex(columns=trained_features, fill_value=0)
