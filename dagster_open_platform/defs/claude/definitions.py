...
from .assets import anthropic_claude_code_report, anthropic_cost_report, anthropic_usage_report
...
def defs() -> Definitions:
    return Definitions(
        assets=[anthropic_usage_report, anthropic_cost_report, anthropic_claude_code_report],
        resources={
